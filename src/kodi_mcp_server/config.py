...
DEFAULT_BRIDGE_BOOTSTRAP_MANIFEST_PATH = PROJECT_ROOT / "addon" / "bridge-bootstrap.json"
DEFAULT_SCREENSHOT_RETENTION_SECONDS = 3600
DEFAULT_SCREENSHOT_MAX_FILES = 100
...
KODI_MCP_TARGETS = os.getenv("KODI_MCP_TARGETS", "")
KODI_MCP_TARGETS_FILE = os.getenv("KODI_MCP_TARGETS_FILE", "")
...
BRIDGE_BOOTSTRAP_MANIFEST_PATH = Path(
    os.getenv(
        "KODI_MCP_BRIDGE_BOOTSTRAP_MANIFEST",
        str(DEFAULT_BRIDGE_BOOTSTRAP_MANIFEST_PATH),
    )
).expanduser()
SCREENSHOT_STORE_DIR = os.getenv("KODI_SCREENSHOT_STORE_DIR") or str(PROJECT_ROOT / "screenshots")
SCREENSHOT_RETENTION_SECONDS = int(
    os.getenv("KODI_SCREENSHOT_RETENTION_SECONDS") or str(DEFAULT_SCREENSHOT_RETENTION_SECONDS)
)
SCREENSHOT_MAX_FILES = int(os.getenv("KODI_SCREENSHOT_MAX_FILES") or str(DEFAULT_SCREENSHOT_MAX_FILES))
VISION_MODEL_URL = os.getenv("KODI_VISION_MODEL_URL", "").strip()
VISION_MODEL_NAME = os.getenv("KODI_VISION_MODEL_NAME", "").strip()
VISION_ENABLED = bool(VISION_MODEL_URL and VISION_MODEL_NAME)
