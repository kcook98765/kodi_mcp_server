...
# Phase 4A Batch D3 adds only bounded WebSocket notification sampling.
BATCH_D3_TARGET_TOOL_NAMES = frozenset({"kodi_notifications_sample"})

# Phase 4A Batch D4 adds only the one-shot bridge log-marker mutation.
BATCH_D4_TARGET_TOOL_NAMES = frozenset({"bridge_write_log_marker"})

# Phase 4A Batch D5 adds only observational GUI screenshot capture.
BATCH_D5_TARGET_TOOL_NAMES = frozenset({"kodi_gui_screenshot"})

# Phase 4B-P1 — Deployment Orchestration Targeting.
BATCH_P1_TARGET_TOOL_NAMES = frozenset(
    {"managed_addon_validate_state"}
)
...
assert BATCH_D3_TARGET_TOOL_NAMES <= TARGET_SCOPED_TOOL_NAMES
assert BATCH_D4_TARGET_TOOL_NAMES <= TARGET_SCOPED_TOOL_NAMES
assert BATCH_D5_TARGET_TOOL_NAMES <= TARGET_SCOPED_TOOL_NAMES
assert BATCH_P1_TARGET_TOOL_NAMES <= HYBRID_TOOL_NAMES
...
assert BATCH_D3_TARGET_TOOL_NAMES.isdisjoint(
    BATCH_A_TARGET_TOOL_NAMES
    | BATCH_B_TARGET_TOOL_NAMES
    | BATCH_C1_TARGET_TOOL_NAMES
    | BATCH_C2_TARGET_TOOL_NAMES
...
assert BATCH_D4_TARGET_TOOL_NAMES.isdisjoint(
    BATCH_A_TARGET_TOOL_NAMES
    | BATCH_B_TARGET_TOOL_NAMES
    | BATCH_C1_TARGET_TOOL_NAMES
    | BATCH_C2_TARGET_TOOL_NAMES
...
assert BATCH_D5_TARGET_TOOL_NAMES.isdisjoint(
    BATCH_A_TARGET_TOOL_NAMES
    | BATCH_B_TARGET_TOOL_NAMES
    | BATCH_C1_TARGET_TOOL_NAMES
    | BATCH_C2_TARGET_TOOL_NAMES
...
assert BATCH_P1_TARGET_TOOL_NAMES.isdisjoint(
    BATCH_A_TARGET_TOOL_NAMES
    | BATCH_B_TARGET_TOOL_NAMES
    | BATCH_C1_TARGET_TOOL_NAMES
    | BATCH_C2_TARGET_TOOL_NAMES
